...
The mapping diagram below provides a high-level view of how the seven clinical information groups in the data dictionary map to FHIR resource types. For the detailed element-by-element mapping, see the [DD Mapping](dd-mapping.html) page.
