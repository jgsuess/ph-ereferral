...
An AI coding assistant (GitHub Copilot) was used throughout this project to accelerate the conversion pipeline. This page documents the key decisions made by the AI, all of which were reviewed and confirmed by the IG author. For the broader methodology, see the [Approach](approach.html) page.
