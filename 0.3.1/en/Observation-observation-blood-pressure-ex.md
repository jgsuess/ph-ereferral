# Observation — Blood Pressure - PH eReferral Implementation Guide v0.3.1

## Example Observation: Observation — Blood Pressure

Profiles: `http://doh.gov.ph/fhir/ph-core/StructureDefinition/ph-core-observation`, [Vital Signs Profile](http://hl7.org/fhir/R4/vitalsigns.html), [Observation Blood Pressure Profile](http://hl7.org/fhir/R4/bp.html)
