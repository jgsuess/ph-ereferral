# Ig Evolution - PH eReferral Implementation Guide v0.3.0-draft
...
Short cycles through the WHO SMART Guideline layers (L1–L5) — as described on the [Approach](approach.md) page — allow the team to surface ambiguities early, incorporate domain-expert feedback, and converge on a model that reflects real-world practice. At this stage:
...
This IG is currently in **Phase 1**. The agile approach described on the [Approach](approach.md) page is the right tool for this stage — it produces working, evaluated content quickly and keeps the cost of change low.
...
1. Conduct a Connectathon or equivalent interoperability test with ≥ 3 independent systems.
1. File a Draft Ballot or STU Ballot, depending on the FMM level reached.
1. Progress through STU releases based on accumulated implementation evidence.
