# Hl 7 Lifecycle - PH eReferral Implementation Guide v0.3.0-draft
...
For context on where this fits in the overall IG evolution, see [IG Evolution](ig-evolution.md).
...
1. **FHIR Maturity Model (FMM) level**— a 0–5 scale that defines**objective, evidence-based criteria**a specification must meet before advancing to the next stage.
