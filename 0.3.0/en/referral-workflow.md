# Referral Workflow - PH eReferral Implementation Guide v0.3.0
...
This workflow is grounded in the same national policy context summarized on the [WHO SMART Guidelines L1 Basis](who-smart-l1.md) page:
